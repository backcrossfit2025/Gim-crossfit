...
export const useStoreUsuarios = defineStore('Usuario', () => {
  ...
  const getAll = async () => {
    try {
      insertarToken()
      const res = await axios.get('https://gim-crossfit.onrender.com/api/usuario/listarUsuarios')
  ...
  const getById = async (_id) => {
    try {
      insertarToken()
      const res = await axios.get(`https://gim-crossfit.onrender.com/api/usuario/listarpor/${_id}`)
      estatus.value = res.status
  ...
  const agregar = async (data) => {
    try {
      const res = await axios.post('https://gim-crossfit.onrender.com/api/usuario/insertarUsuario', data)
      estatus.value = res.status
  ...
  const editar = async (_id, data) => {
    try {
      insertarToken()
      console.log(data); 
      const res = await axios.put(`https://gim-crossfit.onrender.com/api/usuario/editarUsuario/${_id}`, data)
      estatus.value = res.status
      return { success: true, data: res.data }
    } catch (err) {
      estatus.value = err.response?.status || 500
  ...
  const eliminar = async (_id) => {
    try {
      ...
      const res = await axios.delete(`https://gim-crossfit.onrender.com/api/usuario/eliminar/${_id}`)
      estatus.value = res.status
      return { success: true, data: res.data }
    } catch (err) {
      estatus.value = err.response?.status || 500
  ...
  const login = async (data) => {
    ...
    try {
      const res = await axios.post('https://gim-crossfit.onrender.com/api/usuario/login', data)
  ...
  const codigoRecuperar = async (correo) => {
    try {
      const res = await axios.post('https://gim-crossfit.onrender.com/api/usuario/enviar-codigo', { email: correo })
      estatus.value = res.status
  ...
  const confirmarCodigo = async (email, codigo) => {
    try {
      const res = await axios.post('https://gim-crossfit.onrender.com/api/usuario/confirmar-codigo', { email, codigo })
      estatus.value = res.status
      return res.data
    } catch (err) {
      estatus.value = err.response?.status || 500
  ...
  const nuevaPassword = async ({ email, codigo, password }) => {
    try {
      const res = await axios.post('https://gim-crossfit.onrender.com/api/usuario/recuperar-password', {
        email,
        codigo,
  ...
  const activarUsuario = async (_id) => {
    try {
      insertarToken()
      const res = await axios.put(`https://gim-crossfit.onrender.com/api/usuario/activarUsuario/${_id}`)
      estatus.value = res.status
      return { success: true, data: res.data }
    } catch (err) {
      estatus.value = err.response?.status || 500
  ...
  const desactivarUsuario = async (_id) => {
    try {
      insertarToken()
      const res = await axios.put(`https://gim-crossfit.onrender.com/api/usuario/desactivarUsuario/${_id}`)
      estatus.value = res.status
      return { success: true, data: res.data }
    } catch (err) {
      estatus.value = err.response?.status || 500
